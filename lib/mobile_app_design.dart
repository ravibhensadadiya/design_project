import 'dart:convert';
import 'package:design_project/mobile_app_design2.dart';
                ...
                children: [
                  Expanded(
                    child: Stack(
                      ...
                      children: [
                        Image.asset(
                          'assets/images/airo.jpg',
                          fit: BoxFit.cover,
                        ),

                        Container(
                          margin: EdgeInsets.only(top: 480),
                          child: Text((jsonDecode(snapshot.data!.body.toString())[0]['Title']),
                        style: TextStyle(
                          fontSize: 40,
                          fontWeight: FontWeight.bold,color: Colors.white,fontFamily:'Quicksand'),
                        textAlign: TextAlign.center,
                      ),
                    ),
                        Container(
                      margin: EdgeInsets.only(top: 540),
                          child: Text((jsonDecode(snapshot.data!.body.toString())[0]['SubTitle1']),
                    ...
                    Padding(
                      ...
                      child: Container(
                        margin: EdgeInsets.only(top: 548),
                        child: Column(
                          children: [
                            Row(
                              children: [
                                Expanded(
                                    ...
                                    child: Center(
                                      child: TextField(
                                        decoration: InputDecoration(border: InputBorder.none,
                                          ...
                                          labelText: (jsonDecode(snapshot.data!.body.toString())[0]['Text']),
                                  ...
                                  // child: Container(
                                  //   child: TextFormField(obscureText: false,decoration: InputDecoration(border: OutlineInputBorder(),
                                  //       filled: true,
                                  //       fillColor: Colors.white,
                                  //       labelText:'Find the world',prefixIcon: Icon(Icons.search_outlined)),
                                  //   ),
                                  // ),
                                  flex: 3,
                                ),
                                Expanded(
                                  child: Container(height: 50,margin: EdgeInsets.only(left: 15),
                    ...
                    Row(children: [
                      Expanded(
                        child: Container(margin: EdgeInsets.fromLTRB(10, 20, 300, 0),
                          child: Column(
                            children: [
                              ...
                              //               },
                              //             ));
                              //   },child: Container(margin: EdgeInsets.fromLTRB(0, 0, 0, 660),
                      ...
                      Expanded(
                        child: Container(margin: EdgeInsets.fromLTRB(100, 20, 0, 0),
                          child: Column(
                            // crossAxisAlignment: CrossAxisAlignment.stretch,
                            // mainAxisAlignment: MainAxisAlignment.end,
                            children: [
                              CircleAvatar(backgroundImage: NetworkImage((jsonDecode(snapshot.data!.body.toString())[0]
                              ['Image'])),
                                ),
                            ],
                          ),
...
// ON THE WAY
// You can either travel or read,but either\nyour body or soul must be on the way
// Find the world
